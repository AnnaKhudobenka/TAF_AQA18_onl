...
public class CssSelectorTest {
    ...
    public void cssLocatorsTest() {
        driver.get("C:\\Users\\HP\\IdeaProjects\\TestAuto\\src\\test\\resources\\index.html");
        ...
        //search by class name (по нескольким значениям в аттрибуте class)
        ...
        // Поиск всех элементов у кот есть атрибут leng
